...
namespace FIMSpace.FGenerating
{
    ...
    public class FSearchableDropdown<T> : AdvancedDropdown where T : class
    {
        ...
        public FSearchableDropdown(List<T> elements, List<string> names, string title) : base(new AdvancedDropdownState())
        {
            this.title = title;
