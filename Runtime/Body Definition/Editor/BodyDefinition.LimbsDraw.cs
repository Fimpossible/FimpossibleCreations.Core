    ...
    public static partial class BodyDefinitionEditorDraw
    {
        ...
        public static void DrawCoreTab(SerializedProperty sp, BodyDefinition definition)
        {
            ...
            if (definition.SkeletonRoot != null)
            {
                ...
                TransformField(spc, " Root", FGUI_Resources.Tex_Bone);
            }
            else
            {
                if (GUILayout.Button(new GUIContent(FGUI_Resources.Tex_Bone, "Click to try finding root bone automatically"), FGUI_Resources.ButtonStyle, GUILayout.Width(23), GUILayout.Height(18)))
                {
            ...
            TransformFieldB(sp.FindPropertyRelative("HipsBone"), definition.HipsBone, "  Hips", FGUI_Resources.FindIcon("SPR_SPelvis"));
            ...
            imgRect.width = 64;
            imgRect.x -= 14;
            GUI.Label(imgRect, new GUIContent(FGUI_Resources.FindIcon("SPR_BodySpine")));
            //GUI.Box(imgRect, GUIContent.none, FGUI_Resources.BGInBoxStyleH);

            EditorGUILayout.BeginVertical(GUILayout.Width(28));

            if (GUILayout.Button(new GUIContent("+", "Add more spine bones to the chain"), FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(20)))
            {
            ...
            else
            {
                ...
                for (int i = bCount - 1; i >= 0; i--)
                {
                    ...
                    if (i != 0)
                    {
                        ...
                        if (GUILayout.Button(FGUI_Resources.GUIC_Remove, FGUI_Resources.ButtonStyle, GUILayout.Width(26), GUILayout.Height(18))) { toRemove = i; }
        ...
        static void DrawArmsList(List<BodyArmReference> arms, ref int selected, EBodySide side)
        {
            ...
            if (GUILayout.Button("+", FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(18))) { arms.Add(new BodyArmReference()); }
        ...
        static bool DisplayArmSetup(SerializedProperty sp, BodyArmReference arm)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            arm.Shoulder.BodyBone = TransformField(" Shoulder (Optional)", FGUI_Resources.FindIcon("SPR_SShoulder"), "", arm.Shoulder.BodyBone, 18, 140);

            // Auto get arm button display
            if (arm.HandT == null || arm.LowerArmT == null)
                if (arm.ShoulderT || arm.UpperArmT)
                {
                    if (GUILayout.Button(new GUIContent(FGUI_Resources.Tex_Connections, "Click to find lacking bone references automatically."), GUILayout.Width(24), GUILayout.Height(18)))
                    {
            ...
            if (GUILayout.Button(FGUI_Resources.GUIC_Remove, FGUI_Resources.ButtonStyle, GUILayout.Width(24), GUILayout.Height(18))) remove = true;
            EditorGUILayout.EndHorizontal();

            arm.UpperArm.BodyBone = TransformField(" Upper Arm", FGUI_Resources.FindIcon("SPR_SUpperArm"), "", arm.UpperArm.BodyBone);
            arm.LowerArm.BodyBone = TransformField(" Lower Arm", FGUI_Resources.FindIcon("SPR_SLowerArm"), "", arm.LowerArm.BodyBone);
            arm.Hand.BodyBone = TransformField(" Hand", FGUI_Resources.FindIcon("SPR_SHand"), "", arm.Hand.BodyBone);
        ...
        static void DrawLegsList(List<BodyLegReference> legs, ref int selected, EBodySide side)
        {
            ...
            // Add new arm field button
            if (GUILayout.Button("+", FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(18))) { legs.Add(new BodyLegReference()); }
        ...
        static bool DisplayLegSetup(SerializedProperty sp, BodyLegReference leg)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            leg.UpperLeg.BodyBone = TransformField(" Upper Leg", FGUI_Resources.FindIcon("SPR_SUpperLeg"), "", leg.UpperLeg.BodyBone);
            ...
            FGUI_Inspector.RedGUIBackground();
            if (GUILayout.Button(FGUI_Resources.GUIC_Remove, FGUI_Resources.ButtonStyle, GUILayout.Width(28), GUILayout.Height(18))) remove = true;
            FGUI_Inspector.RestoreGUIBackground();

            EditorGUILayout.EndHorizontal();

            leg.LowerLeg.BodyBone = TransformField(" Lower Leg", FGUI_Resources.FindIcon("SPR_SLowerLeg"), "", leg.LowerLeg.BodyBone);
            leg.Ankle.BodyBone = TransformField(" Ankle/Foot", FGUI_Resources.FindIcon("SPR_SAnkle"), "", leg.Ankle.BodyBone);
            leg.Feet.BodyBone = TransformField(" Feet (Optional)", FGUI_Resources.FindIcon("SPR_SFeet"), "", leg.Feet.BodyBone, 18, 130);
        ...
        public static void DrawHeadTab(SerializedProperty sp, BodyDefinition definition)
        {
            ...
            //EditorGUILayout.BeginHorizontal();
            //EditorGUIUtility.labelWidth = 60;
            TransformFieldB(sp.FindPropertyRelative("Head"), definition.HeadReferences.Head, " Head", FGUI_Resources.FindIcon("SPR_SHead"));

            GUILayout.Space(2);
            TransformFieldB(sp.FindPropertyRelative("Jaw"), definition.HeadReferences.Jaw, " Jaw (Optional)", FGUI_Resources.FindIcon("SPR_SJaw"));
            //EditorGUILayout.EndHorizontal();
            ...
            imgRect.width = 64;
            imgRect.x -= 1;
            GUI.Label(imgRect, new GUIContent(FGUI_Resources.FindIcon("SPR_Neck")));
            //GUI.Box(imgRect, GUIContent.none, FGUI_Resources.BGInBoxStyleH);

            EditorGUILayout.BeginVertical(GUILayout.Width(28));

            if (GUILayout.Button(new GUIContent("+", "Add more neck bones to the chain"), FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(20)))
            {
            ...
            GUILayout.Space(3);
            TransformFieldB(sp.FindPropertyRelative("BreathePoint"), definition.HeadReferences.BreathePoint, " Breathe Point (Optional)", FGUI_Resources.FindIcon("SPR_SJaw"));
        ...
        public static void DrawChainsTab(SerializedProperty sp, BodyDefinition definition)
        {
            ...
            else
            {
                for (int i = 0; i < definition.ExtraChains.ExtraChains.Count; i++)
                {
                    ...
                    if (currentWidth + wdth > viewWidth)
                    {
                        ...
                        if (wasButton == false)
                            if (GUILayout.Button("+", FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(18)))
                            {
            ...
            else
            {
                ...
                GUILayout.FlexibleSpace();
                if (GUILayout.Button(new GUIContent(" +", FGUI_Resources.Tex_Bone), EditorStyles.miniButton, GUILayout.MaxWidth(38), GUILayout.Height(19)))
                {
                ...
                bool remove = false;
                FGUI_Inspector.RedGUIBackground();
                if (GUILayout.Button(FGUI_Resources.GUIC_Remove, FGUI_Resources.ButtonStyle, GUILayout.MaxWidth(24), GUILayout.Height(18))) remove = true;
                        ...
                        if (b == 0)
                            if (chain.Bones[b].BodyBone)
                                if (chain.Bones.Count > 0 && chain.Bones[0].BodyBone)
                                {
                                    ...
                                    {
                                        if (GUILayout.Button(new GUIContent(FGUI_Resources.Tex_Connections, "Try assign all child bones in the chain, starting from this bone"), GUILayout.Width(26), GUILayout.Height(18)))
                                        {
