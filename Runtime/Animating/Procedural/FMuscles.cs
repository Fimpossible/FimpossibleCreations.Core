...
{
    /// <summary>
    /// Elastic animation motor for a single value
    /// </summary>
    public abstract class FMuscleMotor
    {
    ...
    /// <summary>
    /// Elastic animation motor for a single float value
    /// </summary>
    public class FMuscleFloat : FMuscleMotor
    {
    ...
    /// <summary>
    /// Elastic animation motor for a single angle value
    /// </summary>
    public class FMuscleAngle : FMuscleMotor
    {
    ...
    /// <summary>
    /// Elastic animation motor for a Vector3
    /// </summary>
    [System.Serializable]
    public class FMuscleVector3
    {
        [HideInInspector] public Vector3 DesiredPosition;
        public Vector3 ProceduralPosition { get; private set; }
        public bool Initialized { get; private set; }

        private FMuscleFloat x;
        private FMuscleFloat y;
        private FMuscleFloat z;
        ...
        public static void Lerp(ref FMuscleVector3 source, FMuscleVector3 a, FMuscleVector3 b, float t)
        {
    ...
    /// <summary>
    /// Elastic animation motor for a Quaternion
    /// </summary>
    [System.Serializable]
    public class FMuscleQuaternion
    {
        ...
        public static void Lerp(ref FMuscleQuaternion source, FMuscleQuaternion a, FMuscleQuaternion b, float t)
        {
            if (a == null || b == null || source == null) return;
    ...
    /// <summary>
    /// Elastic animation motor for a rotations using euler angles
    /// </summary>
    [System.Serializable]
    public class FMuscleEulers
    {
        ...
        private FMuscleAngle x;
        private FMuscleAngle y;
        private FMuscleAngle z;
        ...
        public static void Lerp(ref FMuscleEulers source, FMuscleEulers a, FMuscleEulers b, float t)
        {
            if (a == null || b == null || source == null) return;
