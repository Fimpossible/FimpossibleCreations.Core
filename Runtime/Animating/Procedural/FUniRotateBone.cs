...
{
    /// <summary>
    /// Class which helps to animate bones in unified behaviour, no matter what local and initial orientation it have, within its rig
    /// </summary>
    public class FUniRotateBone
    {
        ...
        public FUniRotateBone(Transform t, Transform root)
        {
            transform = t;
        ...
        public Quaternion RotateCustomAxis(float x, float y, FUniRotateBone oRef)
        {
        ...
        public Vector2 GetCustomLookAngles(Vector3 direction, FUniRotateBone orientationsReference)
        {
