...
{
    public static class FSkeletonRecognize
    {
        ...
        public class FSkeletonInfo
        {
            ...
            public FSkeletonInfo(Transform t, List<Transform> checkOnly = null, Transform pelvisHelp = null)
            {
                AnimatorTransform = t;
...
#if UNITY_EDITOR
                            GUILayout.Space( -4 );
                            FIMSpace.FEditor.FGUIInspector.DrawWarning( " ANIMATOR IS DISABLED! " );
                            GUILayout.Space( 2 );
#endif
                        }
                    }
...
#if UNITY_EDITOR
                        GUILayout.Space( -4 );
                        if( FIMSpace.FEditor.FGUIInspector.DrawWarning( " ANIMATOR NOT FOUND! " ) ) clicks++;
                        GUILayout.Space( 2 );
#endif
                    }
                }
