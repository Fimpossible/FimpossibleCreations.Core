...
namespace FIMSpace.FTools
{
    ...
    /// </summary>
    [System.Serializable]
    public class FimpossibleIKProcessor : FimpossibleIKProcessorBase
    {
        ...
        public FimpossibleIKProcessor(Transform startBone, Transform midBone, Transform endBone)
        {
        ...
        public override void Update()
        {
            ...
            if (posWeight > 0f)
            {
                ...
                {
                    StartBone.transform.rotation = AnimationTools.FAnimationGenerateUtils.EnsureQuaternionContinuity(preS, StartBone.transform.rotation);
                ...
                if (UseEnsuredRotation)
                {
                    MiddleIKBone.transform.rotation = AnimationTools.FAnimationGenerateUtils.EnsureQuaternionContinuity(preM, MiddleIKBone.transform.rotation);
            ...
            if (rotWeight > 0f)
            {
                ...
                if (UseEnsuredRotation)
                {
                    EndBone.transform.rotation = AnimationTools.FAnimationGenerateUtils.EnsureQuaternionContinuity(preE, EndBone.transform.rotation);
        ...
        public class IKBone : FIK_IKBoneBase
        {
            ...
            public void RefreshOrientations(Vector3 childPosition, Vector3 orientationNormal)
            {
                ...
                if (ensured)
                {
                    defaultTargetRotation = FIMSpace.AnimationTools.FAnimationGenerateUtils.EnsureQuaternionContinuity(pre, defaultTargetRotation);
